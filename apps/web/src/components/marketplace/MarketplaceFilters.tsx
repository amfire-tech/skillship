      ...
      <CardContent className="space-y-8 p-6 md:p-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="rounded-2xl bg-slate-50 px-4 py-3 text-sm text-slate-600">
            Showing <span className="font-semibold text-slate-950">{filteredCount}</span> of{" "}
            <span className="font-semibold text-slate-950">{totalCount}</span> workshops
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_1fr_auto]">
          <label className="block">
            ...
            <select
              ...
              className="mt-3 h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-950 outline-none transition-colors focus:border-primary"
            >
