        ...
        <div className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          ...
          <div>
            <MotionSection>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-[var(--foreground)] md:text-4xl lg:text-[42px] lg:leading-[1.12]">
                Schools everywhere are ready for AI. <br className="hidden md:block" />
                The tools weren&apos;t.
              </h2>
            </MotionSection>
            ...
            <MotionSection className="mt-6" delay={1}>
              <p className="text-base leading-relaxed text-[var(--muted-foreground)] md:text-lg">
                We started Skillship after spending time inside real classrooms around
                the world. We saw dedicated teachers, curious students, and principals trying
            ...
            <MotionSection className="mt-8" delay={3}>
              <div className="inline-flex items-center gap-3 rounded-2xl border border-primary/15 bg-primary/5 px-5 py-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-[var(--orange-400)] text-white">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-[var(--foreground)]">
                    Make AI learning measurable for every school, worldwide.
                  </p>
                </div>
              </div>
            </MotionSection>
          ...
          <MotionSection delay={2}>
            <div className="relative">
              ...
              <div className="rounded-3xl border border-[var(--border)] bg-white p-6 shadow-[0_24px_60px_-30px_rgba(243,156,50,0.25)] md:p-8">
                ...
                <div className="mt-8 rounded-2xl bg-gradient-to-br from-primary/5 to-[var(--orange-400)]/5 p-5">
