  ...
  return (
    <motion.div
      ...
      className={`group relative rounded-2xl border p-6 transition-all md:p-8 ${
        layer.highlight
          ? "border-primary/30 bg-gradient-to-br from-primary/10 via-[var(--card)] to-[var(--orange-400)]/5 shadow-[0_24px_60px_-30px_rgba(243,156,50,0.35)]"
          : "border-[var(--border)] bg-[var(--card)] hover:border-primary/20"
      }`}
    >
      {layer.highlight && (
        <span className="absolute -top-3 left-6 inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-primary to-[var(--orange-400)] px-3 py-1 text-xs font-bold uppercase tracking-wider text-white shadow-[0_8px_20px_-8px_rgba(243,156,50,0.6)]">
