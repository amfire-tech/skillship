 ...
 * Purpose: Principal report exports — school PDF/XLSX downloads + auto-report list.
 ...
 *   - GET /api/v1/content/items/?kind=PDF                             (Phase 2.4 auto-reports)
 */
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--muted-foreground)]">
          Download your school&apos;s performance report or pull a previously auto-generated PDF.
        </p>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-xs text-[var(--muted-foreground)]">
              Aggregates quiz performance, class engagement, skill breakdowns, and at-risk signals across your school for the selected period.
            </p>
      ...
      <div className="rounded-2xl border border-[var(--border)] bg-white shadow-sm dark:bg-[var(--background)]">
        <div className="border-b border-[var(--border)] p-5">
          ...
          <p className="mt-0.5 text-xs text-[var(--muted-foreground)]">
            Monthly and yearly PDFs generated automatically by the analytics service on the 1st of each month / Jan 1.
          </p>
        </div>
