...
const roleMeta: Record<string, { label: string; color: string; fields: string[] }> = {
  ...
  PRINCIPAL: {
    ...
    fields: ["full_name", "email", "phone", "school_code", "school_name", "password"],
  },
  STUDENT: {
    label: "Student",
    color: "from-teal-500 to-cyan-400",
    fields: ["full_name", "email", "phone", "school_code", "school_name", "class_grade", "password"],
  },
};
...
const fieldMeta: Record<string, { label: string; type: string; placeholder: string }> = {
  ...
  school_code: { label: "School Code",        type: "text",     placeholder: "e.g. DPS001" },
  school_name: { label: "School Name",        type: "text",     placeholder: "e.g. Delhi Public School, Noida" },
  class_grade: { label: "Class / Grade",      type: "text",     placeholder: "e.g. 9A, 10B" },
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (Object.keys(fieldErrors).length > 0) {
          ...
          setFormError(typeof detail === "string" ? detail : "Failed to create user. Please try again.");
        }
        return;
      }
      setSubmitted(true);
      ...
      <div className="mx-auto max-w-lg py-12">
        ...
        >
          ...
          <div className="mt-7 flex gap-3">
            <button
              onClick={() => { setSubmitted(false); setValues({}); setErrors({}); setFormError(null); }}
          ...
          <div className="p-7 md:p-9">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {meta.fields.map((key, i) => {
                ...
                const isFullWidth = key === "full_name" || key === "password";
